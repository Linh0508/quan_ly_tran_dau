...
-- Bảo mật
CREATE LOGIN [nhom_3_5] WITH PASSWORD = '123456';

USE [QLTD];
CREATE USER [nguyenthithuylinh] FOR LOGIN [nhom_3_5];


GRANT SELECT, INSERT, UPDATE, DELETE ON [CauThu] TO [nguyenthithuylinh];
GRANT EXECUTE ON [proc_CapNhatThongTinTranDau] TO [nguyenthithuylinh];
ALTER ROLE db_owner ADD MEMBER [nguyenthithuylinh];

BACKUP DATABASE [QLTD]
TO DISK = 'C:\BACKUP\QLTD.bak';


RESTORE DATABASE [QLTD]
FROM DISK = 'C:\BACKUP\QLTD.bak'
WITH REPLACE;
